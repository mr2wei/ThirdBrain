...
dependencies {
    ...
    include(modRuntimeOnly("com.fasterxml.jackson.module:jackson-module-kotlin:2.18.2")!!)
    include(modImplementation("com.fasterxml.jackson.core:jackson-core:2.18.2")!!)
    include(modImplementation("com.fasterxml.jackson.core:jackson-annotations:2.18.2")!!)
    include(modImplementation("com.fasterxml.jackson.core:jackson-databind:2.18.2")!!)
    include(modRuntimeOnly("com.fasterxml:classmate:1.7.0")!!)
    include(modRuntimeOnly("com.github.victools:jsonschema-generator:4.38.0")!!)
    include(modRuntimeOnly("com.github.victools:jsonschema-module-jackson:4.38.0")!!)
    include(modRuntimeOnly("com.github.victools:jsonschema-module-swagger-2:4.38.0")!!)
    include(modRuntimeOnly("io.swagger.core.v3:swagger-annotations:2.2.31")!!)
    include(modRuntimeOnly("com.google.errorprone:error_prone_annotations:2.33.0")!!)
